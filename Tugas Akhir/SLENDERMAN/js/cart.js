...
function ready(){
    ...
    var addCart = document.getElementsByClassName("wishlist");
...
function addCartClicked(event){
    ...
    var price = shopProduct.getElementsByClassName('price_tag')[0].innerText;
    var productImg = shopProduct.getElementsByClassName('covers')[0].src;
...
var cartBoxContent = `
                    ...
                    <box-icon name='trash-alt' color='#ffffff' class="bx bxs-trash-alt cart-remove"></box-icon>`;
